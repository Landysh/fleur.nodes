...
public class ApplyCompensationNodeDialog extends DefaultNodeSettingsPane {
    ...
    ApplyCompensationNodeDialog() {
      ...
      SettingsModelBoolean retainedUncompSMB = new SettingsModelBoolean(ApplyCompensationNodeModel.KEY_RETAIN_UNCOMPED, 
          ApplyCompensationNodeModel.DEFAULT_RETAIN_UNCOMPED);
      DialogComponentBoolean retainedUncompDCB = new DialogComponentBoolean(retainedUncompSMB, LABEL_RETAIN_UNCOMPED);
      addDialogComponent(retainedUncompDCB);
      
      //the fcs column filter chooser.
      SettingsModelColumnName columnNameSM = new SettingsModelColumnName(ApplyCompensationNodeModel.KEY_SELECTED_COLUMN, 
