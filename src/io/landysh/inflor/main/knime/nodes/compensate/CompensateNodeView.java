...
/**
 * <code>NodeView</code> for the "Compensate" Node. Will extract a compensation matrix from am FCS
...
public class CompensateNodeView extends NodeView<CompensateNodeModel> {
  ...
  protected void modelChanged() {
    ...
    // update the view.
    CompensateNodeModel nodeModel = (CompensateNodeModel) getNodeModel();
