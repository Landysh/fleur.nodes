...
public class SummaryStatsSettings {
  ...
  private final SettingsModelStringArray m_responseMarkers =
      new SettingsModelStringArray(KEY_RESPONSE_MARKERS, RESPONSE_MARKERS_DEFAULT);
  private final SettingsModelStringArray m_selectedStats =
      new SettingsModelStringArray(SELECTED_STATS_KEY, SELECTED_STATS_DEFAULT);
  private final SettingsModelString m_FCSColumn =
      new SettingsModelString(FCS_COLUMN_KEY, FCS_COLUMN_DEFAULT);
