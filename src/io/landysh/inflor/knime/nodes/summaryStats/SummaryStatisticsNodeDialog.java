...
/**
 * <code>NodeDialog</code> for the "SummaryStatistics" Node. Extract basic
 * summary statistics from a set of FCS Files.
 *
...
public class SummaryStatisticsNodeDialog extends DefaultNodeSettingsPane {
	...
	protected SummaryStatisticsNodeDialog() {
		...
		markerFilter = new DialogComponentStringListSelection(m_settings.getResponseMarkersModel(), "Response Markers",
				new String[] {});

		statFilter = new DialogComponentStringListSelection(m_settings.getSelectedStatsModel(), "Statistics",
