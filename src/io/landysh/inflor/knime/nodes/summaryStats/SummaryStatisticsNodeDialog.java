...
/**
 * <code>NodeDialog</code> for the "SummaryStatistics" Node.
...
public class SummaryStatisticsNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected SummaryStatisticsNodeDialog() {
    	...
    	markerFilter = new DialogComponentStringListSelection(
    			m_settings.getResponseMarkersModel(), 
    			"Response Markers", 
    			new String[] {});
		
		
		statFilter = new DialogComponentStringListSelection(
				m_settings.getSelectedStatsModel(), 
				"Statistics", 
				selectableSummaryStats);
    }
	...
	public void loadAdditionalSettingsFrom(NodeSettingsRO settings, DataTableSpec[] specs)
		...
		ArrayList<String> newItems = (ArrayList<String>) Arrays.asList(vectorNames);
