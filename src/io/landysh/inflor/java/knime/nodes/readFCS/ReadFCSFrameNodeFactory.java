...
/**
 * <code>NodeFactory</code> for the "FCSFrameReader" Node. Reads a data file
 * into an FCS Frame
 *
 * @author Aaron Hart
 */
public class ReadFCSFrameNodeFactory extends NodeFactory<ReadFCSFrameNodeModel> {
	 ...
	 */
	@Override
	public NodeView<ReadFCSFrameNodeModel> createNodeView(final int viewIndex, final ReadFCSFrameNodeModel nodeModel) {
