...
public class SubsetResponseChart {
	...
	public JFreeChart createChart(Map<String, FCSDimension> dataModel){
		...
		double xWidth = (transform.getMaxTransformedValue() - transform.getMinTranformedValue())/ChartingDefaults.BIN_COUNT;
