...
/**
 * <code>NodeView</code> for the "ColumnStoreToTableCell" Node.
 * Converts a 
 *
 * @author Landysh Co.
 */
public class ColumnStoreToTableCellNodeView extends NodeView<ColumnStoreToTableCellNodeModel> {
     ...
     * Creates a new view.
     * 
     * @param nodeModel The model (class: {@link ColumnStoreToTableCellNodeModel})
     */
    ...
    protected void modelChanged() {
        ...
        // update the view.
        ColumnStoreToTableCellNodeModel nodeModel = 
            (ColumnStoreToTableCellNodeModel)getNodeModel();
