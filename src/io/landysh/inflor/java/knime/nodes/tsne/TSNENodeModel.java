...
/**
 * This is the model implementation of the TSNE node for the KNIME Analytics Platform.
...
public class TSNENodeModel extends NodeModel {
    ...
    private final SettingsModelDoubleBounded modelPerplexity = 
    		new SettingsModelDoubleBounded(CFGKEY_Perplexity,
    		DEFAULT_Perplexity,
			MIN_Perplexity,
			MAX_Perplexity
    		);
    ...
    private double[][] readData(BufferedDataTable inData, ExecutionContext exec) throws Exception {
    	...
    	if(rowCount > Integer.MAX_VALUE){
    		throw new Exception("Too many rows, must use fewer that: " 
    							+ Integer.MAX_VALUE + 
