...
public class ViabilityFilterSettingsModel {
  ...
  private final SettingsModelString m_ViabilityColumn =
      new SettingsModelString(CFGKEY_ViabilityColumn, DEFAULT_ViabilityColumn);
  ...
  public SettingsModelString getViabilityColumnSettingsModel() {
    return m_ViabilityColumn;
  }
