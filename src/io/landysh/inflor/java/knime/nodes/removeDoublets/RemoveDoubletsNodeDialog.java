...
public class RemoveDoubletsNodeDialog extends DefaultNodeSettingsPane {
	...
	protected RemoveDoubletsNodeDialog() {
		...
		columnSelectionComponent = 	new DialogComponentColumnNameSelection(
										m_settings.getSelectedColumnSettingsModel(),
										COLUMN_LABEL,
										0,
										new ColumnStoreCellColumnFilter());
		addDialogComponent(columnSelectionComponent);
		
		//Area Selector
		areaComponent = new DialogComponentStringSelection(
				m_settings.getAreaColumnSettingsModel(), 
				AREA_LABEL, 
				defaultChoices
				);
		...
		heightComponent = new DialogComponentStringSelection(
				m_settings.getHeightColumnSettingsModel(), 
				HEIGHT_LABEL, 
				defaultChoices
				);
