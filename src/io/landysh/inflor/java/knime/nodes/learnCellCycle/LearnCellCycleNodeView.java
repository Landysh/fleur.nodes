...
/**
 * <code>NodeView</code> for the "ModelCellCycle" Node. Uses watson pragmatic modeling <citation> to
 * predict the number of cells in each stage of the cell cycle.
 *
 * @author Aaron Hart
 */
public class LearnCellCycleNodeView extends NodeView<LearnCellCyclyNodeModel> {
  ...
  protected void modelChanged() {
    ...
    // update the view.
    final LearnCellCyclyNodeModel nodeModel = getNodeModel();
