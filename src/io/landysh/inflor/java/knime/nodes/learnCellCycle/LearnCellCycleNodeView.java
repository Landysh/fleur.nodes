...
/**
 * <code>NodeView</code> for the "ModelCellCycle" Node. Uses watson pragmatic
...
public class LearnCellCycleNodeView extends NodeView<LearnCellCyclyNodeModel> {
	 ...
	 * 
	 * @param nodeModel
	 *            The model (class: {@link LearnCellCyclyNodeModel})
	 */
	...
	protected void modelChanged() {
		...
		// update the view.
		LearnCellCyclyNodeModel nodeModel = (LearnCellCyclyNodeModel) getNodeModel();
