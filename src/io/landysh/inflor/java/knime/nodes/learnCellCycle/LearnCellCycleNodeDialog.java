...
/**
 * <code>NodeDialog</code> for the "ModelCellCycle" Node. Uses watson pragmatic modeling
 * <citation> to predict the number of cells in each stage of the cell cycle.
 *
...
public class LearnCellCycleNodeDialog extends DefaultNodeSettingsPane {
  ...
  /**
   * New pane for configuring ModelCellCycle node dialog. This is just a suggestion to demonstrate
