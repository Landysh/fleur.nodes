...
/**
 * <code>NodeFactory</code> for the "ModelCellCycle" Node. Uses watson pragmatic modeling
 * <citation> to predict the number of cells in each stage of the cell cycle.
 *
 * @author Aaron Hart
 */
public class LearnCellCycleNodeFactory extends NodeFactory<LearnCellCyclyNodeModel> {
