...
/**
 * <code>NodeView</code> for the "TSNE" Node. Calculates a tSNE using library
 * developed by Leif Jonsson: nhttps://github.com/lejon/T-SNE-Java
 *
 * @author Aaron Hart
 */
public class TSNENodeView extends NodeView<TSNENodeModel> {
	 ...
	 * 
	 * @param nodeModel
	 *            The model (class: {@link TSNENodeModel})
	 */
