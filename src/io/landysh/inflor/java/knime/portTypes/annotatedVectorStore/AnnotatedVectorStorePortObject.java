...
public class AnnotatedVectorStorePortObject extends AbstractSimplePortObject implements PortObject {
	
	public Hashtable<String, String> 					header;
	public String[] 									parameterList;
	public Hashtable<String, Double[]> 					parameterData;

	public AnnotatedVectorStorePortObject(AnnotatedVectorStoreSpec spec, Hashtable<String,Double[]> data) {
		header = spec.header;
	...
	public PortObjectSpec getSpec() {
		PortObjectSpec ps = new AnnotatedVectorStoreSpec(header,parameterList);
		return ps;
	}
