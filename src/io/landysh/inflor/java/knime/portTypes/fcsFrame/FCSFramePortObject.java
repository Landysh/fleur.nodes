package io.landysh.inflor.java.knime.portTypes.fcsFrame;
...
import io.landysh.inflor.java.knime.dataTypes.FCSFrameCell.FCSFrameContent;
...
public class FCSFramePortObject extends FileStorePortObject {
  ...
  public FCSFrameCell toTableCell(FileStore fs) {
    getColumnStore();
