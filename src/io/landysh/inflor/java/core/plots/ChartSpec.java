...
public class ChartSpec extends DomainObject {
	...
	//Getters
	public PlotTypes getPlotType() 		{return plotType;}
	public String getDomainAxisName() 	{return domainAxisName;}
	public String getRangeAxisName() 	{return rangeAxisName;}
	public String getParent() 			{return parent;}
	public AbstractTransform getRangeTransform() {return rangeTransform;}
	public AbstractTransform getDomainTransform(){return domainTransform;}
	//Setters
	public void setDomainAxisName(String newValue)  		 	{domainAxisName = newValue;}
	public void setParent(String newValue) 		    		 	{parent = newValue;}
	public void setPlotType(PlotTypes newValue) 			  	{plotType = newValue;}
	public void setRangeAxisName(String newValue) 			  	{rangeAxisName = newValue;}
	public void setRangeTransform(AbstractTransform newValue) 	{rangeTransform = newValue;}
	public void setDomainTransform(AbstractTransform newValue)	{domainTransform = newValue;}
}
