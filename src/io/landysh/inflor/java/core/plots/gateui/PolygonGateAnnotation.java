...
public class PolygonGateAnnotation extends XYPolygonAnnotation implements XYGateAnnotation{
	...
	public PolygonGateAnnotation(String subsetName, String domainAxisName, String rangeAxisName, double[] polygon, BasicStroke stroke, Color color) {
	...
	public XYGateAnnotation cloneSelected() {
		return new PolygonGateAnnotation(subsetName, domainAxisName, rangeAxisName,
				polygonPoints, LookAndFeel.SELECTED_STROKE, LookAndFeel.SELECTED_GATE_COLOR);
	}

	@Override
	public XYGateAnnotation cloneDefault() {
		return new PolygonGateAnnotation(subsetName, domainAxisName, rangeAxisName,
				polygonPoints, LookAndFeel.DEFAULT_STROKE, LookAndFeel.DEFAULT_GATE_COLOR);
	}
	...
	public XYGateAnnotation translate(double dx, double dy) {
		...
		return new PolygonGateAnnotation(subsetName, domainAxisName, rangeAxisName,
				translatedPoints, LookAndFeel.SELECTED_STROKE, LookAndFeel.SELECTED_GATE_COLOR);
	}
	...
	public XYGateAnnotation updateVertex(Point2D v, double dx, double dy, double xHandleSize, double yHandleSize) {
		...
		return new PolygonGateAnnotation(subsetName, domainAxisName, rangeAxisName,
				newPoints, LookAndFeel.SELECTED_STROKE, LookAndFeel.SELECTED_GATE_COLOR);
	}
