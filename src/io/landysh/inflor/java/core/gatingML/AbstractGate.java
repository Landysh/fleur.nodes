...
public abstract class AbstractGate {
	/**
	 * An abstract class that provides the basis for all gating-ml 
	 * compliant gates.
	 * @see RangeGate
	 */
	 ...
	 */
	abstract boolean[] evaluate(Hashtable <String, double[]> data, int eventCount);
	
	/**
	 * @return A list of the dimension names for this gate.
	 */
	public abstract ArrayList<String> getDimensionNames();
