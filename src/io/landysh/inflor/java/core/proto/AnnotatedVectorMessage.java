	...
	public static final class AnnotatedVectorsProto extends com.google.protobuf.GeneratedMessage implements
		...
		public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>implements
			...
			public AnnotatedVectorMessage.AnnotatedVectorsProto build() {
				final AnnotatedVectorMessage.AnnotatedVectorsProto result = buildPartial();
			...
			public AnnotatedVectorMessage.AnnotatedVectorsProto buildPartial() {
				final AnnotatedVectorMessage.AnnotatedVectorsProto result = new AnnotatedVectorMessage.AnnotatedVectorsProto(
						this);
		...
		public static final class Keyword extends com.google.protobuf.GeneratedMessage implements
			...
			public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>implements
				...
				public AnnotatedVectorMessage.AnnotatedVectorsProto.Keyword build() {
					final AnnotatedVectorMessage.AnnotatedVectorsProto.Keyword result = buildPartial();
					if (!result.isInitialized()) {
						throw newUninitializedMessageException(result);
					}
					return result;
				...
				public AnnotatedVectorMessage.AnnotatedVectorsProto.Keyword buildPartial() {
					final AnnotatedVectorMessage.AnnotatedVectorsProto.Keyword result = new AnnotatedVectorMessage.AnnotatedVectorsProto.Keyword(
							this);
					final int from_bitField0_ = bitField0_;
					int to_bitField0_ = 0;
				...
				public java.lang.String getValue() {
					final java.lang.Object ref = value_;
					if (!(ref instanceof java.lang.String)) {
						final com.google.protobuf.ByteString bs = (com.google.protobuf.ByteString) ref;
						final java.lang.String s = bs.toStringUtf8();
						if (bs.isValidUtf8()) {
		...
		public static final class Vector extends com.google.protobuf.GeneratedMessage implements
			...
			public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>implements
				...
				public AnnotatedVectorMessage.AnnotatedVectorsProto.Vector build() {
					final AnnotatedVectorMessage.AnnotatedVectorsProto.Vector result = buildPartial();
					if (!result.isInitialized()) {
						throw newUninitializedMessageException(result);
					}
					return result;
				...
				public AnnotatedVectorMessage.AnnotatedVectorsProto.Vector buildPartial() {
					final AnnotatedVectorMessage.AnnotatedVectorsProto.Vector result = new AnnotatedVectorMessage.AnnotatedVectorsProto.Vector(
							this);
					final int from_bitField0_ = bitField0_;
					int to_bitField0_ = 0;
					if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
				...
				public java.lang.String getTransformPref() {
					final java.lang.Object ref = transformPref_;
					if (!(ref instanceof java.lang.String)) {
						final com.google.protobuf.ByteString bs = (com.google.protobuf.ByteString) ref;
						final java.lang.String s = bs.toStringUtf8();
						if (bs.isValidUtf8()) {
