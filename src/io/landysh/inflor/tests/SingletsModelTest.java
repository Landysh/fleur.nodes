...
public class SingletsModelTest {
	...
	// Case 1
	String[] testParameters1 = { "FL3-H", "FL2-A", "FL2-H", "FL13-H", "FL1-A", "Time", "FL12-A", "FL1-H", "FSC-Width",
			"FL12-H", "SSC-A", "FL13-A", "FL11-A", "SSC-H", "FL11-H", "FSC-A", "FL10-A", "FSC-H", "FL10-H", "FL8-H",
			"FL9-A", "FL7-A", "FL9-H", "FL7-H", "FL8-A", "FL6-A", "FL6-H", "FL5-A", "FL5-H", "FL4-A", "FL4-H",
			"FL3-A" };

	// Case 2
	String[] testParameters2 = { "CD3 CD14 Live/Dead-A", "PE-Cy7-A", "PE-Cy55-A", "PE-A", "FITC/Alexa 488-A", "SSC-W",
			"SSC-H", "SSC-A", "FSC-W", "Time", "FSC-H", "APC-H7-A", "FSC-A", "APC-Ax700-A", "APC/Ax 647-A" };
