...
public class ScatterPlotUITest extends ApplicationFrame {

	public ScatterPlotUITest(String title) throws Exception {
		super(title);
	...
	public static void main(String[] args) throws Exception {
		ScatterPlotUITest test = new ScatterPlotUITest("ScatterPlotTest");
		test.pack();
